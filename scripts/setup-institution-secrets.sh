...

{
  ...
  echo "File: $OUT_FILE"
  echo ""
  echo "Browser: Login = $(echo "$INST_ID" | tr '[:upper:]' '[:lower:]') · Salt = (value above)"
  echo "Note: when this file is loaded, demo pilot/pilot and DEMO are replaced unless --with-demo"
